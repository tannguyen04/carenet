...
*/
 ...
 $ACCESS_PWD='111'; #script access password, SET IT if you want to protect script from public access
...
ini_set('session.save_handler', 'files');
 ...
 $DB=array(
 'user'=>$databases['default']['default']['username'],#required
 'pwd'=>urldecode($databases['default']['default']['password']), #required
 'db'=>trim($databases['default']['default']['database'], '/'),  #default DB, optional
 'host'=>$databases['default']['default']['host'],#optional
 'port'=>$databases['default']['default']['port'],#optional
